...
const CUSTOMER_AREAS: CairoArea[] = ['Maadi', 'Zamalek', 'Heliopolis'];

export const CUSTOMER_ACCOUNTS = [
  { phone: '0110000001', name: 'فاطمة أحمد' },
  { phone: '0110000002', name: 'عمر خالد' },
  { phone: '0110000003', name: 'نورة سعيد' },
] as const;
...
export const USER_SEEDS: User[] = [
  ...
  ...CUSTOMER_ACCOUNTS.map((c, i) => ({
    id: `customer-${c.phone}`,
    phone: c.phone,
    role: 'customer' as const,
    name: c.name,
    area: CUSTOMER_AREAS[i],
    createdAt: '2026-04-01T00:00:00.000Z',
  })),
];
