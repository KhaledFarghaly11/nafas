...
export default ({ config }: ConfigContext): ExpoConfig => ({
  ...
  splash: { image: './assets/splash-icon.png', resizeMode: 'contain', backgroundColor: '#FAF3E8' },
  ios: { supportsTablet: false, bundleIdentifier: 'com.nafas.app' },
  android: {
    adaptiveIcon: { foregroundImage: './assets/adaptive-icon.png', backgroundColor: '#FAF3E8' },
