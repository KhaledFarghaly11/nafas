...
- [x] T022 Create minimal design tokens — create `src/design/tokens.ts` with: `lightTokens` object: `{ colors: { background: "#FAF3E8", text: "#2C1A0E", textSecondary: "#6B3F28", primary: "#C1714F", primaryLight: "#E8A838", error: "#B84C3C", success: "#5B8C6A", warning: "#E8A838", surface: "#F0E6D3", border: "#D9CCBC", tabBackground: "#FAF3E8", tabBarInactive: "#9E8A78", skeletonBase: "#F0E6D3", skeletonHighlight: "#FAF3E8" } }`, `darkTokens` object: `{ colors: { background: "#1A110A", text: "#FAF3E8", textSecondary: "#9E8A78", primary: "#C1714F", primaryLight: "#D4927A", error: "#D45A4A", success: "#7DADA0", warning: "#E8A838", surface: "#261A10", border: "#3D2C1E", tabBackground: "#1A110A", tabBarInactive: "#6B5A4A", skeletonBase: "#2C1A0E", skeletonHighlight: "#3D2C1E" } }`. Full Nafas design tokens (clay, saffron, cream, linen, oud, bark, smoke, mint, rose, warmWhite, overlay) are added in Phase 2. Export both objects. See `specs/001-project-setup/plan.md` Constitution Check post-design note.
